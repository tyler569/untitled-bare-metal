...
message_info_t
dispatch_method (struct cap *slot, message_info_t info)
{
    ...
    case METHOD_cnode_copy:
      {
        ...
        dbg_printf (
            ...
            cap_type_string (cap_type (slot)), dest_index, dest_depth,
            cap_type_string (cap_type (src_root)), src_index, src_depth,
            rights);
    ...
    case METHOD_cnode_delete:
      {
        ...
        dbg_printf ("(cap:%s, index=%#lx, depth=%hhu)\n",
                    cap_type_string (cap_type (slot)), index, depth);
    ...
    case METHOD_tcb_configure:
      {
        ...
        dbg_printf (
            ...
            cap_type_string (cap_type (slot)), fault_ep,
            cap_type_string (cap_type (cspace_root)), cspace_root_data,
            cap_type_string (cap_type (vspace_root)), vspace_root_data, buffer,
            cap_type_string (cap_type (buffer_frame)));
    ...
    case METHOD_tcb_read_registers:
      {
        ...
        dbg_printf ("(cap:%s, suspend_source=%d, arch_flags=%#lx, count=%#lx, "
                    "regs=%p)\n",
                    cap_type_string (cap_type (slot)), suspend_source,
    ...
    case METHOD_tcb_bind_notification:
      {
        ...
        dbg_printf ("(cap:%s, notification=cap:%s)\n",
                    cap_type_string (cap_type (slot)),
                    cap_type_string (cap_type (notification)));
    ...
    case METHOD_tcb_set_tls_base:
      {
        ...
        dbg_printf ("(cap:%s, tls_base=%#lx)\n",
                    cap_type_string (cap_type (slot)), tls_base);
    ...
    case METHOD_tcb_write_registers:
      {
        ...
        dbg_printf ("(cap:%s, resume_target=%d, arch_flags=%#lx, count=%#lx, "
                    "regs=%p)\n",
                    cap_type_string (cap_type (slot)), resume_target,
                    arch_flags, count, regs);
    ...
    case METHOD_tcb_set_debug:
      {
        ...
        dbg_printf ("(cap:%s, flags=%#lx)\n",
                    cap_type_string (cap_type (slot)), flags);
    ...
    case METHOD_tcb_set_name:
      {
        ...
        dbg_printf ("(cap:%s, name=%p, len=%#lx)\n",
                    cap_type_string (cap_type (slot)), name, len);
    ...
    case METHOD_untyped_retype:
      {
        ...
        dbg_printf ("(cap:%s, type=%#lx, size_bits=%#lx, root=cap:%s, "
                    ...
                    "num_objects=%#lx)\n",
                    cap_type_string (cap_type (slot)), type, size_bits,
                    cap_type_string (cap_type (root)), node_index, node_depth,
    ...
    case METHOD_x86_64_io_port_out8:
      {
        ...
        dbg_printf ("(cap:%s, port=%#lx, value=%#lx)\n",
                    cap_type_string (cap_type (slot)), port, value);
    ...
    case METHOD_x86_64_io_port_control_issue:
      {
        ...
        dbg_printf ("(cap:%s, first_port=%#lx, last_port=%#lx, root=cap:%s, "
                    "index=%#lx, depth=%hhu)\n",
                    cap_type_string (cap_type (slot)), first_port, last_port,
                    cap_type_string (cap_type (root)), index, depth);
    ...
    case METHOD_x86_64_pdpt_map:
      {
        ...
        dbg_printf ("(cap:%s, vspace=cap:%s, vaddr=%#lx, attr=%#lx)\n",
                    cap_type_string (cap_type (slot)),
                    cap_type_string (cap_type (vspace)), vaddr, attr);
    ...
    case METHOD_irq_control_get:
      {
        ...
        dbg_printf (
            ...
            cap_type_string (cap_type (slot)), irq,
            cap_type_string (cap_type (root)), index, depth);
